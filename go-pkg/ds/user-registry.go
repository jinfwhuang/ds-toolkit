...
//
// Solidity: function newUser(address user, string name, uint8 keytype, uint8 keystatus, bytes pubkey) returns()
func (_UserRegistry *UserRegistryTransactor) NewUser(opts *bind.TransactOpts, user common.Address, name string, keytype uint8, keystatus uint8, pubkey []byte) (*types.Transaction, error) {
	return _UserRegistry.contract.Transact(opts, "newUser", user, name, keytype, keystatus, pubkey)
}

// NewUser is a paid mutator transaction binding the contract method 0xaba0caae.
//
// Solidity: function newUser(address user, string name, uint8 keytype, uint8 keystatus, bytes pubkey) returns()
func (_UserRegistry *UserRegistrySession) NewUser(user common.Address, name string, keytype uint8, keystatus uint8, pubkey []byte) (*types.Transaction, error) {
	return _UserRegistry.Contract.NewUser(&_UserRegistry.TransactOpts, user, name, keytype, keystatus, pubkey)
}

// NewUser is a paid mutator transaction binding the contract method 0xaba0caae.
//
// Solidity: function newUser(address user, string name, uint8 keytype, uint8 keystatus, bytes pubkey) returns()
func (_UserRegistry *UserRegistryTransactorSession) NewUser(user common.Address, name string, keytype uint8, keystatus uint8, pubkey []byte) (*types.Transaction, error) {
	return _UserRegistry.Contract.NewUser(&_UserRegistry.TransactOpts, user, name, keytype, keystatus, pubkey)
}
