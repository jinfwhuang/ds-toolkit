...
type UserRegistryLoginClient interface {
	RequestLogin(ctx context.Context, in *UserLogin, opts ...grpc.CallOption) (*UserLogin, error)
	Login(ctx context.Context, in *UserLogin, opts ...grpc.CallOption) (*LoginResp, error)
	Debug(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*UserLogin, error)
}
...
func (c *userRegistryLoginClient) RequestLogin(ctx context.Context, in *UserLogin, opts ...grpc.CallOption) (*UserLogin, error) {
	out := new(UserLogin)
...
func (c *userRegistryLoginClient) Login(ctx context.Context, in *UserLogin, opts ...grpc.CallOption) (*LoginResp, error) {
	out := new(LoginResp)
...
func (c *userRegistryLoginClient) Debug(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*UserLogin, error) {
	out := new(UserLogin)
	err := c.cc.Invoke(ctx, "/jinfwhuang.dstoolkit.identity.UserRegistryLogin/Debug", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserRegistryLoginServer interface {
	RequestLogin(context.Context, *UserLogin) (*UserLogin, error)
	Login(context.Context, *UserLogin) (*LoginResp, error)
	Debug(context.Context, *emptypb.Empty) (*UserLogin, error)
...
func (UnimplementedUserRegistryLoginServer) RequestLogin(context.Context, *UserLogin) (*UserLogin, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RequestLogin not implemented")
}
func (UnimplementedUserRegistryLoginServer) Login(context.Context, *UserLogin) (*LoginResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Login not implemented")
}
func (UnimplementedUserRegistryLoginServer) Debug(context.Context, *emptypb.Empty) (*UserLogin, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Debug not implemented")
}
...
func _UserRegistryLogin_RequestLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserRegistryLoginServer).RequestLogin(ctx, req.(*UserLogin))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _UserRegistryLogin_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserRegistryLoginServer).Login(ctx, req.(*UserLogin))
	}
	return interceptor(ctx, in, info, handler)
}

func _UserRegistryLogin_Debug_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserRegistryLoginServer).Debug(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/jinfwhuang.dstoolkit.identity.UserRegistryLogin/Debug",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserRegistryLoginServer).Debug(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserRegistryLogin_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Debug",
			Handler:    _UserRegistryLogin_Debug_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "identity/login.proto",
